...
status = unit_test_mcc( 'broadcast', 4, cpus, 200, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'basic_app', 4, cpus, 400, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'basic_app2', 4, cpus, 400, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'basic_app3', 4, cpus, 400, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

%status = unit_test_mcc( 'basic_app4', 4, cpus, 400, 20 );
%if (strcmp(status,'FAIL'))
%  all_status = 'FAIL';
%end

status = unit_test_mcc( 'xbasic', 4, cpus, 200, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'basic', 2, cpus, 200, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'multi_basic', 2, cpus, 200, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'probe', 2, cpus, 200, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end


status = unit_test_mcc( 'speedtest', 2, cpus, 400, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end

status = unit_test_mcc( 'blurimage', 4, cpus, 400, 20 );
if (strcmp(status,'FAIL'))
  all_status = 'FAIL';
end
