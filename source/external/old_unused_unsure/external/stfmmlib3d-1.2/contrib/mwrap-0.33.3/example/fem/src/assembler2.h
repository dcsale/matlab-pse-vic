...
/*
 * The MatrixAssembler2 class is responsible for assembling a finite element
 ...
 * structure.  This means that after K is assembled once, we can
...
public:
    MatrixAssembler2(int m, int n) : m(m), n(n), jc(n+1) {}
    MatrixAssembler2(int m, int n, int coord_nnz) : 
